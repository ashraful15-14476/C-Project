...
int main(){
    ...
    printf("\t\t\t 5. Press '5' for Calculation History");
    printf("\n\t\t\t\t");
    scanf("%d",&opt);
    switch(opt)
    {
...
void file_w(float inp, char msg[])
{
    ...
    fileWrite= fopen("fileNamed.txt", "a");
    fprintf(fileWrite,"\n\n\t\t\t\t%s %.2f",msg,inp);
    fclose(fileWrite);
